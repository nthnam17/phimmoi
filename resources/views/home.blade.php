...
@section('content')
 <div class="row-one widgettable">
          ...
          <!-- for amcharts js -->
          <script src="{{asset('admin_panel/js/amcharts.js')}}"></script>
          <script src="{{asset('admin_panel/js/serial.js')}}"></script>
          <script src="{{asset('admin_panel/js/export.min.js')}}"></script>
          <link
            rel="stylesheet"
            href="{{asset('admin_panel/css/export.css')}}"
            type="text/css"
            media="all"
          />
          <script src="{{asset('admin_panel/js/light.js')}}"></script>
          <!-- for amcharts js -->
          <script src="{{asset('admin_panel/js/index1.js')}}"></script>
          <div class="charts">
